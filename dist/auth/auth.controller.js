...
const register_dt_1 = require("./dto/register.dt");
...
let AuthController = class AuthController {
    ...
    async login(loginDto, session, res) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [register_dt_1.RegisteDto]),
